...
It intentionally contains no Thoughtful Systems service implementation, deployment
...
| --- | --- | --- |
| [Thoughtful Systems](./system/) | Build and run governed team tools through one OAuth-protected MCP connection. | `system@thoughtful-systems` |

## Install from this marketplace

After this repository is public, add it as a marketplace and install Thoughtful Systems.

### Claude Code

```sh
claude plugin marketplace add thoughtful-systems/plugins
claude plugin install system@thoughtful-systems
```
...
codex plugin add system@thoughtful-systems
```
...
The optional `bun run eval:skill` suite compares Thoughtful Systems behavior with and without
...
See [`system/PUBLISHING.md`](./system/PUBLISHING.md) for the remaining directory
submission gates.
